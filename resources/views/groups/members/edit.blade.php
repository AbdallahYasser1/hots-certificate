    ...
    <div class="py-12">
        <div class=" flex flex-col sm:justify-center items-center p-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
                ...
                <form action="{{ route('group_members.update',[$group,$groupMember]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="name" name="name" value="{{ old('name',$groupMember->name) }}" type="text"
                                      required
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="name" name="email" value="{{ old('email',$groupMember->email) }}"
                                      type="text" required
                                      class="block mt-1 w-full"/>
