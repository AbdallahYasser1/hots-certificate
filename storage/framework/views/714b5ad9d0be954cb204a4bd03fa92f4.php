...
<?php endif; ?>
                    ...
                    <div class="float-right">
                        <a href="<?php echo e(route('members.import.form',$group)); ?>"
                           class="mb-4 inline-flex items-center rounded-md border border-gray-300  px-4 py-2 text-xs font-semibold uppercase tracking-widest text-gray-700 shadow-sm transition duration-150 ease-in-out hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25">
                            Upload Group Members From CSV
                        </a>
                        <br>
                        <a href="<?php echo e(route('group_members.create',$group)); ?>"
                           class="mb-4 inline-flex items-center rounded-md border border-gray-300  px-4 py-2 text-xs font-semibold uppercase tracking-widest text-gray-700 shadow-sm transition duration-150 ease-in-out hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25">
                            Add Group Member
                        </a>
                    </div>
                    ...
                    <label class="font-semibold text-gray-700"> Group Members:</label>
                        ...
                        <table class="min-w-full border divide-y divide-gray-200">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $group->members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="bg-white">
                                    ...
                                    <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                        <a href="<?php echo e(route('group_members.edit', [$group, $member])); ?>"
                                           class="inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-widest text-gray-700 shadow-sm transition duration-150 ease-in-out hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25">
                                            Edit
                                        </a>
                                        <form action="<?php echo e(route('group_members.destroy', [$group, $member])); ?>"
                                              method="POST"
...
<?php /**PATH C:\laragon\www\hots-certificates\resources\views/groups/show.blade.php ENDPATH**/ ?>